...
@LoadBalancerClients(
        value = {
                @LoadBalancerClient(name = "res-food", configuration = MyLoadBalancerClientConfiguration.class),
                @LoadBalancerClient(name = "res-order", configuration = MyLoadBalancerClientConfiguration.class),
                @LoadBalancerClient(name = "res-security", configuration = MyLoadBalancerClientConfiguration.class)
